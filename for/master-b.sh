...
(mkdir $MainPath/ClangRepo && cd $MainPath/ClangRepo && git init && git remote add origin https://${GIT_SECRET}@github.com/${GIT_USERNAME}/SDClang && git checkout -b 10)
...
. $MainPath/misc/bot.sh "send_info" "SDClang 10.0.11 uploaded"