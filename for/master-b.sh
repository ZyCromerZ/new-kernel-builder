...
(mkdir $MainPath/ClangRepo && cd $MainPath/ClangRepo && git init && git remote add origin https://${GL_N}:${GL_S}@gitlab.com/${GIT_USERNAME}/sdclang-16.0.2.0 && git checkout -b main)
...
. $MainPath/misc/bot.sh "send_info" "SDClang 16.0.2.0 uploaded to https://gitlab.com/ZyCromerZ/sdclang-16.0.2.0"